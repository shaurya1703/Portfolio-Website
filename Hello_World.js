// {Name: Hello_Mini}
// {Description: Hello Mini example of the Alan Platform functionality: intent() / play() / user- and pre-defined slots / contexts}
...
// Try activating the button in the bottom right corner and saying "Hello Mini".
